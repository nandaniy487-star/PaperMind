...
export default function UploadPaper({ onBack }) {
  ...
  const handleDragOver = (e) => {
    e.preventDefault();
    e.stopPropagation();
    if (!isLoading && !isDragging) setIsDragging(true);
  };
  ...
  const handleUploadClick = async () => {
    ...
    try {
      ...
      if (error.response?.data?.detail) {
        ...
        setErrorMessage(error.message || 'An error occurred during paper upload.');
      }
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="upload-page">
      <div className="upload-container">
        ...
        <div className="upload-nav-header">
          <button className="btn-back" type="button" onClick={onBack} disabled={isLoading}>
        ...
        <div className="upload-header">
          ...
          <p className="upload-subtitle">
            Upload an academic publication in PDF format. The backend extracts text, chunks it with overlap,
            generates dense vector embeddings, and stores them in ChromaDB.
          </p>
        </div>
          ...
          {successData ? (
            <div className="upload-success-view">
              ...
              <div className="success-text-content">
                <h3 className="success-title">{successData.message || 'Upload Complete!'}</h3>
                <p className="success-subtext">
                  Your research paper is now indexed and stored in ChromaDB, ready for contextual AI inquiries.
                </p>
              </div>
              ...
              <div className="success-meta-grid">
                <div className="meta-stat-card">
                  ...
                  <strong className="stat-value text-ellipsis" title={successData.filename}>
                ...
                <div className="meta-stat-card highlight-stat">
                  ...
                  <strong className="stat-value">{successData.chunks_created}</strong>
                </div>

                <div className="meta-stat-card">
                  <span className="stat-label">Vector Store</span>
                  <strong className="stat-value stat-status">ChromaDB Indexed</strong>
                </div>
              </div>

              <div className="success-actions">
                <button type="button" className="btn-upload-submit" onClick={handleUploadAnother}>
            ...
            <>
              {/* Dropzone */}
              <div
                className={`dropzone ${isDragging ? 'dropzone-active' : ''} ${selectedFile ? 'dropzone-has-file' : ''} ${isLoading ? 'dropzone-disabled' : ''}`}
                  ...
                  <div className="file-info-header">
                    ...
                    <div className="file-primary-details">
                      <div className="file-name-row">
                        ...
                        <span className={`file-status-tag ${isLoading ? 'tag-indexing' : ''}`}>
                          {isLoading ? 'Indexing in progress...' : 'Ready to Process'}
                        </span>
                      </div>
                      <div className="file-meta-row">
                        ...
                        <span className="meta-dot">•</span>
                        <span className="meta-item">Target: /upload-paper</span>
                      </div>
                    </div>
              ...
              {isLoading && (
                <div className="loading-stage-notice">
                  ...
                  <div className="loading-stage-text">
                    ...
                    <span>
                      Extracting text via PyMuPDF, computing dense embeddings, and updating ChromaDB. Please don't refresh.
                    </span>
                  </div>
                </div>
              )}
              ...
              <div className="upload-actions">
                <button
                  type="button"
                  className={`btn-upload-submit ${!selectedFile || isLoading ? 'btn-disabled' : ''}`}
                ...
                <button type="button" className="btn-cancel" onClick={onBack} disabled={isLoading}>
                  Cancel
                </button>
              </div>
            </>
        ...
        <div className="pipeline-preview">
          <h4 className="pipeline-title">Backend RAG Pipeline Process:</h4>
          <div className="pipeline-steps">
            <div className="pipeline-step">
              <div className="step-num">1</div>
              <div className="step-text">
                <strong>PyMuPDF Text Extraction</strong>
                <span>Directly processes PDF streams and extracts full paper content.</span>
              </div>
            </div>
            <div className="pipeline-step">
              ...
              <div className="step-text">
                ...
                <span>1000-character windows embedded into ChromaDB with 384 dimensions.</span>
              </div>
            </div>
            <div className="pipeline-step">
              ...
              <div className="step-text">
                ...
                <span>Indexed vectors are primed for semantic similarity search &amp; RAG answers.</span>
              </div>
            </div>
          </div>
        </div>
